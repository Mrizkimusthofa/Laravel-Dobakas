    ...
    <x-auth-card>
        ...
        <div class="text-center mb-4">
            <h2 class="text-lg font-bold text-gray-900">
                Bergabung dengan DOBAKAS | Donasi Barang Bekas
            </h2>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div class="flex items-start space-x-2">
                ...
                <label for="terms" class="text-sm text-gray-600">
                    Saya setuju dengan <a href="#" class="text-berkah-secondary hover:text-berkah-primary transition-colors">syarat dan ketentuan</a> serta <a href="#" class="text-berkah-secondary hover:text-berkah-primary transition-colors">kebijakan privasi</a> DOBAKAS
                </label>
            </div>
            @error('terms')
                <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
